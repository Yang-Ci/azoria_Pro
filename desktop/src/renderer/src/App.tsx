...
export default function App() {
  ...
  const connectBluetooth = () => {
    ...
    }).catch((error) => { setBleName(""); setMessage(error instanceof Error ? error.message : "蓝牙连接失败") })
